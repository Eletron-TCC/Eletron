...
<body>
  ...
  <div class="modelos-iphone">
          <div class="navegacao-iphone">
            <a href="airpodsG2.php">  <img src="./imagens/imagensprodutos/airpodG2.jpg">
                        <h5>AirPod <br> (2ª geração) </h5></a>
              </div>

              <div class="navegacao-iphone">
                <a href="airpodsG3.php">   <img src="./imagens/imagensprodutos/airpodG3.jpg">
                          <h5>AirPod <br> (3ª geração)</h5></a>
                </div>

                <div class="navegacao-iphone">
                  <a href="airpodsPro.php">   <img src="./imagens/imagensprodutos/airpods Pro.jpg">
                            <h5>AirPod Pro</h5></a>
                  </div>

                  <div class="navegacao-iphone">
                    <a href="airpodsMax.php">  <img src="./imagens/imagensprodutos/airpods max vermelho.jpg">
                              <h5>AirPod Max</h5></a>
                    </div>
...
<div class="imagens-corpo-iphone">
  <a href="#"><img src="imagens/banner airpod 1.png" ></a>
  <a href="#"><img src="imagens/banner airpod 2.png" ></a>
...
<div id="container-item">
  ...
  <div class="produto">
      <img src="./imagens/imagensprodutos/airpods max vermelho.jpg">
          <h5>AirPod Max - Vermelho</h5>                 
            <h2> R$6,000</h2>
            
</div>

  <div class="produto">
    <img src="./imagens/imagensprodutos/airpodsG2 inducao.jpg">
    <h5>AirPod 2 geraçao - carrega por induçao</h5>                   
            <h2> R$6,000</h2>
</div>

<div class="produto">
  <img src="./imagens/imagensprodutos/airpods max azul.jpg">
  <h5>AirPod Max - Azul</h5>                   
          <h2> R$6,000</h2>
</div>

<a href="#">
  <div class="produto">
    <img src="./imagens/imagensprodutos/airpods Pro.jpg">
    <h5>Apple AirPods Pro com estojo de recarga MagSafe</h5>              
            <h2> R$1,899</h2>
</div>
</a>
