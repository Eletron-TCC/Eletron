...
<body>
  ...
  <div class="modelos-iphone">
          <div class="navegacao-iphone">
            <a href="iMac.php"> <img src="./imagens/imagensprodutos/iMac27.jpg">
                        <h5>iMac</h5></a> 
              </div>

              <div class="navegacao-iphone">
                <a href="MacBookAir.php"> <img src="./imagens/imagensprodutos/MacBookAir Cinza espacial 256GB.jpg">
                          <h5>MacBook Air</h5></a> 
                </div>

              <div class="navegacao-iphone">
                <a href="MacBookPro.php"> <img src="./imagens/imagensprodutos/MacBook Pro.jpg">
                          <h5>MacBook Pro</h5></a> 
                </div>
                  </div>
</div>
...
<div class="imagens-corpo-iphone">
  <a href="#"><img src="imagens/banner macbook 1.png" ></a>
  <a href="#"><img src="imagens/banner macbook 2.png" ></a>
...
<div id="container-item">
  ...
  <div class="produto">
      <img src="./imagens/imagensprodutos/macbook pro 13,3 cinza.jpg">
          <h5>MacBook Pro 13,3 - cinza</h5>                 
            <h2> R$13,816,00</h2>
  ...
  <div class="produto">
    ...
    <h5>MacBook Air - Prateado 256GB</h5>                   
            <h2> R$13,816,00</h2>
</div>

  <div class="produto">
    <img src="./imagens/imagensprodutos/MacBook Pro  prata.jpg">
    <h5>Macbook pro - prata</h5>                 
            <h2> R$13,763,00</h2>
</div>

  <div class="produto">
    <img src="./imagens/imagensprodutos/MacBookAir Cinza espacial 256GB.jpg">
    <h5>MacBook Air Cinza Espacial - 256GB</h5>                    
            <h2> R$13,254,00</h2>
</div>
</div>
