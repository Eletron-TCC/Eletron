...
<div class="todos-produt">
  ...
  <div id="container-item">
    ...
    <div class="produto">
        <img src="./imagens/imagensprodutos/iphone11.webp">
            <h5>Apple iPhone 11 (64GB) - Preto</h5>                 
              <h2> R$3,200</h2>
    ...
    <div class="produto">
        <img src="./imagens/imagensprodutos/iphone11 branco.jpg">
            <h5>Apple iPhone 11 (64GB) - Branco</h5>                 
              <h2> R$3,200</h2>
  </div>
    ...
    <div class="produto">
        <img src="./imagens/imagensprodutos/iphone11 roxo.jpg">
            <h5>Apple iPhone 11 (64GB) - Roxo</h5>                 
              <h2> R$3,200</h2>
  </div>

  <div class="produto">
    <img src="./imagens/imagensprodutos/iphone11 roxo.jpg">
        <h5>Apple iPhone 11 (128GB) - Roxo</h5>                 
          <h2> R$3,700</h2>
</div>
...
<div class="produto">
    <img src="./imagens/imagensprodutos/iphone11 branco.jpg">
        <h5>Apple iPhone 11 (128GB) - Branco</h5>                 
          <h2> R$3,700</h2>
</div>

          <div class="produto">
            <img src="./imagens/imagensprodutos/iphone11 vermelho 64gb.jpg">
                <h5>Apple iPhone 11 (128GB) - (PRODUCT) RED™</h5>                 
                  <h2> R$3,800</h2>
      </div>

    <div class="produto">
        <img src="./imagens/imagensprodutos/iphone11 pro max branco.jpg">
            <h5>apple iphone 11 pro max 256GB - Branco</h5>                 
              <h2> R$6,500</h2>
  </div>

  <div class="produto">
    <img src="./imagens/imagensprodutos/iphone11 pro max verde.jpg">
        <h5>apple iphone 11 pro max 256GB - verde</h5>                 
          <h2> R$6,400</h2>
</div>


<div class="produto">
  <img src="./imagens/imagensprodutos/iphone11 pro max dourado.webp">
      <h5>apple iphone 11 pro max 256GB - Dourado</h5>                 
        <h2> R$6,500</h2>
</div>
