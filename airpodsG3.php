...
<head>
<meta charset="utf-8">
<title>Eletron - Airpods 3ª geração</title>
  ...
  <div class="icones-header">
      <a href="PagLogin.php">
        ...
        // CASO NÃO ESTEJA LOGADO, MOSTRAR A OPÇÃO DE LOGAR NO SISTEMA
            ...
            <li><a href="./PagLogin.php">Entar</a></li> 
        </ul>
         <?php }?>
        </div>
      </a>
...
<div class="todos-produt">
  ...
  <div id="container-item">
    ...
    <a href="#">
    <div class="produto">
      <img src="./imagens/imagensprodutos/airpodG3.jpg">
      <h5>AirPods (3ª geração) com estojo de recarga Lightning</h5>              
              <h2> R$1,699</h2>
  </div>
</a>
