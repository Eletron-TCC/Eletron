...
<head>
<meta charset="utf-8">
<title>Eletron - Apple Watch SE</title>
...
<div class="todos-produt">
  ...
  <div id="container-item">
    ...
    <div class="produto">
        <img src="./imagens/imagensprodutos/applewatchSE aluminio dourado.jpg">
    ...
    <div class="produto">
      <img src="./imagens/imagensprodutos/applewatchSE cinza-espacial.jpg">
      <h5>Apple Watch SE Cellular + GPS, 44 mm, Alumínio Dourado, Pulseira Esportiva Loop Ameixa</h5>                 
              <h2> R$3,299</h2>
  </div>

    <div class="produto">
      <img src="./imagens/imagensprodutos/applewatchSE dourado de aluminio pulseira bege.jpg">
      <h5>Apple Watch SE GPS, 44 mm, Alumínio Dourado, Pulseira Esportiva Rosa- MYDR2BE/A</h5>                    
              <h2> R$3,299</h2>
  </div>
    ...
    <div class="produto">
      <img src="./imagens/imagensprodutos/ApplewatchSE nike.jpg">
            <h5>Apple Watch SE Nike+ GPS, 40 mm - Caixa de alumínio Prata - Pulseira esportiva Platina / Preto</h5>                 
              <h2> R$2,900</h2>
  </div>

    <div class="produto">
      <img src="./imagens/imagensprodutos/appleWatchSE prata aluminio pulseira branca.jpg">
      <h5>Apple Watch SE Cellular + GPS, 44 mm, Alumínio Prata, Pulseira Esportiva Branco - MYEV2BE/A</h5>              
              <h2> R$2,900</h2>
  </div>
