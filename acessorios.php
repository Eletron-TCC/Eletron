...
<head>
<meta charset="utf-8">
<title>Eletron - Acessorios</title>
...
<body>
  ...
  <section class="corpo-iphone">
    ...
    <div class="imagens-corpo-iphone">
      <a href="#"><img src="imagens/banner acessorios 1.png"></a>
      <a href="#"><img src="imagens/banner acessorio 2.png" ></a>
    ...
    <div id="container-item">
      ...
      <div class="produto">
          <img src="./imagens/imagensprodutos/acessorio 2.jpg">
              <h5>Adaptador Multiportas, USB, HDMI, USB-C, RJ45, iPlace</h5>                 
                <h2> R$520,00</h2>
                
    </div>
    
      <div class="produto">
        <img src="./imagens/imagensprodutos/acessorio 3.jpg">
        <h5>Adaptador Apple de USB-C para AV Digital, Multiporta</h5>                   
                <h2> R$599,00</h2>
    </div>
    
      <div class="produto">
        <img src="./imagens/imagensprodutos/acessorio 4.jpg">
        <h5>Cabo USB Apple para Lightning, 1 metro, Branco</h5>                 
                <h2> R$230,00</h2>
    </div>
    
      <div class="produto">
        <img src="./imagens/imagensprodutos/acessorio 5.jpg">
        <h5>Carregador de Parede Mistertech, Universal, USB-C/ USB, 30W, Branco</h5>                 
        <h2> R$160,00</h2>
    </div>
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 6.jpg">
      <h5>Carregador de Parede Mistertech, Universal, USB-C/ USB, 30W, Preto</h5>                 
      <h2> R$160,00</h2>
    </div>
    
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 7.jpg">
      <h5>Pulseira Apple Watch 38 / 40 mm iPlace, Beagá, Silicone Amarelo</h5>                    
              <h2> R$130,00</h2>
    </div>
    
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 9.jpg">
      <h5>Pulseira Apple Watch 38 / 40 mm iPlace, Beagá,Silicone arco iris</h5>                    
              <h2> R$130,00</h2>
    </div>
    
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 8.jpg">
      <h5>Pulseira Apple Watch 38 / 40 mm iPlace, Beagá, Silicone vermelha</h5>                    
              <h2> R$130,00</h2>
    </div>
    
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 10.jpg">
      <h5>Pulseira Apple Watch 38 / 40 mm iPlace, amarela</h5>                    
              <h2> R$130,00</h2>
    </div>
    
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 11.jpg">
      <h5>Pulseira Apple Watch 38 / 40 mm iPlace, Beagá, azul</h5>                    
              <h2> R$130,00</h2>
    </div>
    
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 12.jpg">
      <h5>Pulseira Apple Watch 38 / 40 mm iPlace, Beagá, verde</h5>                    
              <h2> R$130,00</h2>
    </div>
    ...
    <div class="produto">
      <img src="./imagens/imagensprodutos/acessorio 14.jpg">
      <h5>Pulseira Apple Watch 38 / 40 mm iPlace, Beagá, azul</h5>                    
              <h2> R$130,00</h2>
    </div>
    
    <div class="produto">
      <img src="./imagens/imagensprodutos/caboiphone 3m.jpg">
      <h5>Cabo Lightning para USB-C (3º Geração) iPlace, 1,2 metros, Branco</h5>                    
              <h2> R$189,00</h2>
    </div>
